...
![Cortex®-M4 结构框图](https://picgo-chaoxiaohan.oss-cn-qingdao.aliyuncs.com/img/Cortex®-M4 结构框图.png)
...
![GD32F4xx 器件的系统架构示意图](https://picgo-chaoxiaohan.oss-cn-qingdao.aliyuncs.com/img/GD32F4xx 器件的系统架构示意图.png)
