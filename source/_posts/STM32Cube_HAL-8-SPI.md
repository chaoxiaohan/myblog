...
tags:
  ...
  - W25Q128
  - Flash
excerpt: 介绍STM32 HAL库中SPI通信的使用，包括W25Q128闪存芯片的读写操作。
description: 
---
...
![在这里插入图片描述](https://picgo-chaoxiaohan.oss-cn-qingdao.aliyuncs.com/img/f10ce33874cd17e95a4e060190d378ef.png)
我的是 外部晶振为8MHz
